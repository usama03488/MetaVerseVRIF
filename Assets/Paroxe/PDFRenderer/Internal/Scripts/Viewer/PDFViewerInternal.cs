...
namespace Paroxe.PdfRenderer.Internal.Viewer
{
    public class PDFViewerInternal : UIBehaviour
    {
        ...
        {
	        m_PDFViewer.GoToNextPage(FindObjectOfType<PDFViewer>().GetMostVisiblePageIndex());
        }
        ...
        {
	        m_PDFViewer.GoToPreviousPage(FindObjectOfType<PDFViewer>().GetMostVisiblePageIndex());
        }
