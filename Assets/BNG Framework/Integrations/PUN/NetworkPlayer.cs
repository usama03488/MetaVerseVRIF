...
namespace BNG {
...

    {
        ...
        [Tooltip(" Tranform of the local player body to track")]
        public Transform PLayerBody;
        public Transform PlayerBodyRemote;
        ...
        void Update() {
            ...
            if (!photonView.IsMine) {
                ...
                CustomupdateRemotePositionRotation(PlayerBodyRemote, _syncBodyStartPosition, _syncBodyEndPosition, _syncBodyStartRotation, _syncBodyEndRotation, synchValue);
        ...
        public void AssignPlayerObjects() {
            ...
            PLayerBody = getChildTransformByName(player.transform, "BodyPivot");
        ...
        void toggleObjects(bool enableObjects) {
            PlayerBodyRemote.gameObject.SetActive(enableObjects);
        ...
        void CustomupdateRemotePositionRotation(Transform moveTransform, Vector3 startPosition, Vector3 endPosition, Quaternion syncStartRotation, Quaternion syncEndRotation, float syncValue)
        {
            float dist = Vector3.Distance(startPosition, endPosition);
        ...
        public void OnPhotonSerializeView(PhotonStream stream, PhotonMessageInfo info) {
            ...
            if (stream.IsWriting) {
                ...
                //Body
                this._syncBodyStartPosition = PlayerBodyRemote.position;
                this._syncBodyEndPosition = (Vector3)stream.ReceiveNext();
                this._syncBodyStartRotation = PlayerBodyRemote.rotation;
